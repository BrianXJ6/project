...
/***/ "./resources/js/user/config/axios/index.js":
/*!*************************************************!*\
  !*** ./resources/js/user/config/axios/index.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _require = __webpack_require__(/*! ../../store */ "./resources/js/user/store/index.js"),
    store = _require["default"];

var environment = 'user';
var rtLogout = '/cliente/logout';
var rtLogin = '/cliente/login';
...
/***/ "./resources/js/user/config/environment/index.js":
/*!*******************************************************!*\
  !*** ./resources/js/user/config/environment/index.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var baseUrl = '/cliente/dashboard'; // Routes

var routes = [{
  path: baseUrl,
  component: function component() {
    return Promise.all(/*! import() */[__webpack_require__.e("/js/vendor"), __webpack_require__.e("resources_js_user_views_layouts_App_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ./../views/layouts/App */ "./resources/js/user/views/layouts/App.vue"));
  },
  children: [{
    path: '',
    name: 'dashboard',
    component: function component() {
      return Promise.all(/*! import() */[__webpack_require__.e("/js/vendor"), __webpack_require__.e("resources_js_user_views_pages_home_Home_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ./../views/pages/home/Home */ "./resources/js/user/views/pages/home/Home.vue"));
    }
  }, {
    path: 'perfil',
    name: 'profile',
    component: function component() {
      return Promise.all(/*! import() */[__webpack_require__.e("/js/vendor"), __webpack_require__.e("resources_js_user_views_pages_profile_Profile_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ./../views/pages/profile/Profile */ "./resources/js/user/views/pages/profile/Profile.vue"));
    }
  }]
}]; // Start
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _config_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config/environment */ "./resources/js/user/config/environment/index.js");
/* harmony import */ var _config_axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./config/axios */ "./resources/js/user/config/axios/index.js");
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./router */ "./resources/js/user/router/index.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./store */ "./resources/js/user/store/index.js");
// Environment
 // Config local
...
/******/ __webpack_require__.O(0, ["/js/vendor"], () => (__webpack_exec__("./resources/js/user/user.js")));
